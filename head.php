...
<div style='width:1000px; margin:auto; background-color: #E2D2C9;min-height:800px;'>
 ...
 <?php }?> 
  ...
  <div style="<?php if(isset($_SESSION['username'])&&strstr($_SERVER['SCRIPT_NAME'],"admin.php")==false) echo "width:800px; float:right";else echo "margin:auto;"; ?>">
    
     <?php
        if(strstr($_SERVER['SCRIPT_NAME'],"admin.php")!==false){
	   ?>
       <div class='topmenu'  style="height:60px; line-height:50px; padding-left:80px; background-image:url(images/menu.gif); background-position:center; background-repeat:no-repeat; margin-top:20px;">
        <a href='admin.php?mod=type&act=list' style="font-weight:bolder;">餐厅设置</a>   &nbsp;  &nbsp;
        <a href='admin.php?mod=goods&act=list' style="font-weight:bolder;">菜品管理</a>  &nbsp;  &nbsp;
        <a href='admin.php?mod=orders&act=list' style="font-weight:bolder;">订单管理</a>  &nbsp;  &nbsp;
        <a href='admin.php?mod=book&act=list' style="font-weight:bolder;">留言管理</a>  &nbsp;  &nbsp;
        <a href='admin.php?mod=comment&act=list' style="font-weight:bolder;">评论管理</a>  &nbsp;  &nbsp;
        <a href='admin.php?mod=user&act=list'  style="font-weight:bolder;">会员管理</a>  &nbsp;  &nbsp; 
        <a href='admin.php?mod=data&act=list'  style="font-weight:bolder;">订餐统计</a>  &nbsp;  &nbsp;
       <a href="javascript:if(confirm('您确定要退出吗?'))location='index.php?mod=user&act=out'"><b>退出登录</b></a> 
      </div>
       <?php
     }
    ?>